...
public class ArbolB {
    ...
    // if (this != null) {
    // if (x != v) {
    // this.search(v).erase(v);
    // } else {
    // // If the node is a leaf, then set empty to true. cleanUp() will deal with
    // it.
    // if (this.isLeaf()) {
    // empty = true;
    // } else {
